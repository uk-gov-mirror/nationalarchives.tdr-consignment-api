...
libraryDependencies ++= Seq(
  ...
  "software.amazon.awssdk" % "rds" % "2.44.14",
  "software.amazon.awssdk" % "sts" % "2.44.14",
  ...
  "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.288",
  ...
  "uk.gov.nationalarchives" %% "tdr-statuses" % "0.0.26"
)
